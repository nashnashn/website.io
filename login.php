...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
  ...
  <a class="navbar-brand" href="#" style="font-size:30px;"><strong>SORS</strong></a>
  ...
  <img class="card-img-top mx-auto" src="images/user-icon.jpg" style="width: 60%; " alt="Card image cap">
  <div class="card-body">
 ...
 <button type="submit" class="btn btn-outline-success"><i class="fa fa-lock">&nbsp;</i> Login</button> &nbsp; &nbsp; 
  <button type="reset" class="btn btn-outline-warning "><i class="fa fa-repeat">&nbsp;</i> Reset</button>
