...
<body>
	...
	<div class="container">
<a href="https://lexacademy.in" target="_blank"><img src="images/saasa.png" alt="" width="350px" height="200">	</a><br><hr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="images/full-page-banner-background-hd-free-download.jpg" width="300px" height="80px" alt=""></center>
...
<select name="state" class="form-control">
  <option selected>Choose...</option>
  <option value="Santa Mesa">Sta. Mesa</option>
